// Current filmaking equipment
let camera = "Canon 80D";
...
(function ($) {
    ...
    document.getElementById("stabilizer").innerHTML = stabilizer;
    document.getElementById("gopro").innerHTML = gopro;
...
function scrollToSection(divClass) {
    $('html,body').animate({scrollTop: $(divClass).offset().top}, 'slow');
}